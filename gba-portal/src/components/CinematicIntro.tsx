          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-6">
              ...
              >
                 ...
                 <p className={`${cinzel.className} text-white/50 text-xs md:text-sm uppercase tracking-[0.5em] mt-12 font-medium`}>
              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-4">
                    <span className={`${teko.className} text-2xl md:text-3xl uppercase font-bold tracking-[0.15em] text-white group-hover:text-black transition-colors duration-500`}>
                      Découvrir l'univers
                    </span>
                    <Play 
                        size={18} 
