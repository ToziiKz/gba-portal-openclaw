...
export type StockPole = "École de foot" | "Pré-formation" | "Formation" | "Club";
...
export const stockPoles: StockPole[] = ["Club", "École de foot", "Pré-formation", "Formation"];

export const stockLocations: StockLocation[] = ["Clubhouse", "Local équipement", "Terrain"];

export const stockKinds: Array<{ id: StockItemKind | "all"; label: string; note: string }> = [
