...
export const reportPeriods: Array<{ id: ReportPeriod; label: string; note: string }> = [
  { id: "7d", label: "7 jours", note: "opérationnel" },
  { id: "30d", label: "30 jours", note: "tendance" },
  { id: "season", label: "Saison", note: "macro" },
];

export const reportPoles: Array<ReportPole> = ["École de foot", "Pré-formation", "Formation"];
...
export const dashboardReportsMock: DashboardReportPack[] = [
  {
    ...
    licenceBreakdown: [
      { id: "l1", label: "École de foot", value: 5, total: 42, note: "1 retard" },
      { id: "l2", label: "Pré-formation", value: 7, total: 36, note: "2 retards" },
      { id: "l3", label: "Formation", value: 2, total: 28, note: "0 retard" },
    ],
    equipmentBreakdown: [
      { id: "e1", label: "Tailles manquantes", value: 4, total: 64, note: "avant commande" },
      { id: "e2", label: "Dotation non remise", value: 6, total: 64, note: "maillots / shorts" },
      { id: "e3", label: "Chaussettes à échanger", value: 2, total: 64, note: "taille" },
    ],
    attendanceBreakdown: [
  ...
  },
  {
    ...
    licenceBreakdown: [
      { id: "l1", label: "École de foot", value: 8, total: 42, note: "2 retards" },
      { id: "l2", label: "Pré-formation", value: 10, total: 36, note: "3 retards" },
      { id: "l3", label: "Formation", value: 3, total: 28, note: "0 retard" },
    ],
    equipmentBreakdown: [
      { id: "e1", label: "Tailles manquantes", value: 6, total: 64, note: "+2 nouveaux" },
      { id: "e2", label: "Dotation non remise", value: 7, total: 64, note: "" },
      { id: "e3", label: "Chaussettes à échanger", value: 4, total: 64, note: "" },
    ],
    attendanceBreakdown: [
