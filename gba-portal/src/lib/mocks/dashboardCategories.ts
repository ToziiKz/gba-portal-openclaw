...
export const dashboardCategoryPoles: CategoryPole[] = ["École de foot", "Pré-formation", "Formation", "Seniors"];
...
export const dashboardCategoriesMock: DashboardCategory[] = [
  ...
  },
  {
    ...
    playersEstimate: 34,
    leadStaff: [
      { id: "st-cat-003", name: "S. Kader", role: "resp-categorie" },
    ],
  ...
  },
  {
    ...
    playersEstimate: 26,
    leadStaff: [
      { id: "st-cat-006", name: "A. Morel", role: "coord" },
    ],
  ...
  },
  {
    ...
    playersEstimate: 55,
    leadStaff: [
      { id: "st-cat-009", name: "D. Garcia", role: "coord" },
    ],
