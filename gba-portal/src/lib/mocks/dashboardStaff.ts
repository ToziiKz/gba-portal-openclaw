export type StaffPole = "École de foot" | "Pré-formation" | "Formation" | "Club";
...
export const staffPoles: StaffPole[] = ["École de foot", "Pré-formation", "Formation", "Club"];

export const staffRoles: Array<{ id: StaffRole | "all"; label: string; note: string }> = [
  ...
  { id: "administratif", label: "Administratif", note: "licences / logistique" },
];
