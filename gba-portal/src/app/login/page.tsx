  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#020202] via-[#050505] to-[#000000] px-6 py-24">
      <div className="mx-auto w-full max-w-xl rounded-[2.5rem] border border-white/10 bg-white/5 p-10 shadow-[0_25px_90px_rgba(0,0,0,0.65)] backdrop-blur">
        <p className="text-xs uppercase tracking-widest text-white/60">Accès staff</p>
        ...
        <div className="mt-8 flex flex-col gap-4">
          <form action={nextPath} method="get" className="grid gap-3">
            <label className="text-xs uppercase tracking-widest text-white/50" htmlFor="accessCode">
            ...
            <button
              type="submit"
              className="rounded-full border border-white/40 bg-gradient-to-r from-[#00a1ff] to-[#0065bd] px-6 py-3 text-center text-sm font-bold text-white shadow-[0_15px_50px_rgba(0,161,255,0.45)]"
            >
              Continuer vers le dashboard
            </button>
            <Link
              href={nextPath}
              className="btn-ghost inline-flex items-center justify-center rounded-full border border-white/20 bg-white/5 px-6 py-3 text-center text-xs font-bold text-white/80 transition hover:border-white/40 hover:bg-white/10"
            >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Link
              href="/"
              className="btn-ghost rounded-full border border-white/25 bg-white/5 px-6 py-3 text-center text-sm font-bold text-white/90 transition-transform duration-200 hover:scale-[1.03] hover:border-white/40 active:scale-[0.99]"
            >
              Retour à la vitrine
            </Link>
            <Link
