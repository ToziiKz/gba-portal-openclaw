...
export const metadata: Metadata = {
  ...
  description: "Conditions d’utilisation de GBA Portal : accès, responsabilités, propriété, contact.",
  alternates: {
    canonical: "/terms",
  },
};
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-white/70">
          Certaines zones sont réservées (staff, parents, partenaires). Vous êtes responsable de la confidentialité de vos identifiants.
          Toute tentative d’accès non autorisé peut entraîner une suspension.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-white/70">
          Les visuels, textes, marques et éléments d’interface restent la propriété de leurs titulaires. Les contenus fournis par le club ou les
          partenaires restent sous leur responsabilité.
        </p>
      </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-white">Disponibilité & limites</h2>
        <p className="text-sm leading-relaxed text-white/70">
          On vise une disponibilité élevée, mais un service web peut connaître des interruptions (maintenance, incidents, réseau). Les
          informations affichées sont fournies “en l’état” et doivent être recoupées pour les décisions sensibles.
        </p>
        <p className="text-xs text-white/45">Micro-copy premium : le produit est sérieux, mais la réalité reste le terrain.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-white/70">
          ...
          <a className="underline decoration-white/30 underline-offset-4 hover:text-white" href={`mailto:${contactEmail}`}>
            {contactEmail}
          </a>
          .
        </p>
