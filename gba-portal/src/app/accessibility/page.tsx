...
export const metadata: Metadata = {
  title: "Accessibilité",
  description: "Engagement accessibilité de GBA Portal : navigation clavier, contrastes, contenus, contact et retours.",
  alternates: {
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-white/70">
          Certaines animations et effets “cinématiques” peuvent être plus difficiles à appréhender. On cherche un équilibre : un rendu premium,
          sans pénaliser l’usage.
        </p>
      ...
      <div className="space-y-4">
        ...
        <p className="text-xs text-white/45">
          Micro-copy premium : l’accessibilité n’est pas un badge — c’est une promesse produit. Merci de nous aider à la tenir.
        </p>
      </div>
    </TrustPageShell>
  );
