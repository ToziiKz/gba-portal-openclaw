...
const news = [
  {
    ...
    date: '2026-02-01',
    summary:
      'Tournoi jeunes, buvette, photos : une journée club qui rassemble toutes les générations.',
    tag: 'Vie de club',
  },
  {
    ...
    date: '2026-01-25',
    summary:
      'Boulangerie Martin devient official partner et soutient la formation et la vie locale.',
    tag: 'Partenaires',
  },
  {
    ...
    date: '2026-01-20',
    summary:
      'Maillot, écharpe, pack supporter : une boutique simple et locale (paiement hors-ligne pour l’instant).',
    tag: 'Boutique',
  },
]
      ...
      >
        <section aria-labelledby="news-list" className="space-y-6">
          ...
          <p className="text-sm leading-relaxed text-white/70">
            Objectif : une lecture rapide (mobile) et des contenus courts. Pas de base de données
            pour l’instant : les entrées ci-dessous sont statiques.
          </p>
              ...
              <article key={item.title} className="premium-card card-shell rounded-3xl p-6">
                ...
                {item.tag === 'Boutique' ? (
                  <p className="mt-4 text-xs text-white/50">
                    Envie de soutenir ?{' '}
                    <Link href="/shop" className="font-semibold text-white/75 hover:text-white">
                      Voir la boutique
                    </Link>
                    .
                  </p>
          ...
          <div className="rounded-3xl border border-white/10 bg-black/40 p-6">
            ...
            <p className="mt-3 text-sm text-white/70">
              Une page article par actu (URL dédiée), filtres (jeunes / seniors / partenaires), et
              mise en avant des liens utiles (boutique, dossiers sponsor).
            </p>
          </div>
        </section>
      </TrustPageShell>
