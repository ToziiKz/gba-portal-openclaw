      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 22, marginBottom: 40 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ fontSize: 22, letterSpacing: 10, opacity: 0.75, textTransform: "uppercase" }}>
              Groupement Bruche Ackerland
            </div>
            <div style={{ fontSize: 64, fontWeight: 900, letterSpacing: 2, marginTop: 8 }}>GBA Portal</div>
          </div>
        </div>

        <div style={{ fontSize: 34, fontWeight: 600, opacity: 0.88, maxWidth: 980, lineHeight: 1.15 }}>
